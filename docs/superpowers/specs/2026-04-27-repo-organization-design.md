...
- **`docs/`** — everything about _what we're building_: architecture, specs, design mockups, branding
- **`research/`** — everything _external we investigated_: Chelhead capture, EA API artifacts
